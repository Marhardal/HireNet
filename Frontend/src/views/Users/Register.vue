    ...
    <template v-slot:other>
        <FormKit type="form" submit-label="Sign-up" @submit="authStore.Register(values)">
            <div class="grid grid-cols-2 gap-x-4 mx-auto justify-center max-w-4xl">
                ...
                <div class="col-span-1">
                    <FormKit type="number" label="Phone Number" validation="required" v-model="values.phone"
                ...
                <div class="col-span-1">
                    <FormKit type="password" name="password" v-model="values.password" label="Password" placeholder="Enter your Password."
                        validation="required" />
                </div>
                <div class="col-span-1">
