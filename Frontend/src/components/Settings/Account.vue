...
<template>
    <div class="mx-auto max-w-2xl">
        <FormKit type="form" submit-label="Update" @submit="authStore.Register(values)" v-if="authStore.authUser">
            <div class="grid grid-cols-2 gap-x-4 justify-center w-full">
                <div class="col-span-1">
                    <FormKit type="text" placeholder="Enter your First Name." v-model="values.first_name"
                        label="First Name" validation="required" :value="authStore.authUser.first_name" />
                </div>
                <div class="col-span-1">
